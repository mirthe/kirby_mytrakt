<?php $localfile =  __DIR__ . "/favshows.json";
$feedurl = "https://api.trakt.tv/users/". option('mirthe.mytrakt.username') ."/recommendations/shows/title";
...
foreach ($json_a as $key => $value): ?>
  ...
  <?php $imgcall = "https://api.themoviedb.org/3/tv/" . 
